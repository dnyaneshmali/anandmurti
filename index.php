         ...
         <div class="row stylish-panel">
            <div class="col-md-6  ">
               <div id ="f1" class="single-faq panel panel-default">
                  <div class="content-icon"><span class="fa fa-thumbs-up" aria-hidden="true"></span></div>
                  <div class="box-right">
               ...
               <div id ="f2" class="single-faq panel panel-default">
                  <div class="content-icon"><span class="fa fa-certificate" aria-hidden="true">
                  </div>
                  <div class="box-right">
                     <span class="panel-body">
                        <h4><b>Quality products</b></h4>
                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text</p>
                     </span>
                  </div>
               </div>
            ...
            <div class="col-md-6">
               ...
               <div id="f4" class="single-faq panel panel-default">
                  <div class="content-icon"><span class="fa fa-truck" aria-hidden="true">
                  </div>
                  <div class="box-right">
                     <span class="panel-body">
