                     ...
                     <div class="col-md-6 col-sm-12 col-xs-12 col-lg-12 offset-md-6">
                        <div class="contentarea">
                           <div class="innerright">
                              ...
                              <ul class="info">
                                 <li>
                                    <img src="/anandmurti/assets/images/mail.png" alt="" class="cnt" width="58" height="58" />
                                    <span>
                                       <h2>Email</h2>
                                       <a href="mailto:jxyz@india.co.in">anandmurti@india.co.in</a> 
                                    </span>
                                 </li>
                                 <li>
                                 ...
                                 <li>
                                    <img src="/anandmurti/assets/images/diirection.png" alt="" class="cnt"   width="58" height="58"  />
                                    <span>
                                       <h2>Direction</h2>
                              ...
                              <div class="contfrm">
                                 ...
                                 <div class="cntright"> <strong>Go Gas center</strong><br />
                                    ...
                                    Pune -110 057<br />
                                    India<br />
                                    Email address for investors :<a href="mailto:jal.investor@jalindia.co.in">anandmurti@india.co.in</a> 
                                 </div>
                              </div>
                           </div>
