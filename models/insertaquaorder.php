...
$newdelivery_date = date("d-m-Y", strtotime($ddate));
$order_status = '0';
$order_reminder = '0';
...
$query = "INSERT INTO tbl_aqua_orders(order_quantity, order_price, order_delivery_address, order_delivery_date, order_delivery_time, vehicle_name, order_status, order_reminder,order_date,jar_id, acustomer_id,order_activestatus)
    VALUES('".$data['order_quantity']."', '".$data['order_price']."', '".$data['order_address']."', '".$newdelivery_date."', '".$data['order_time']."','".$data['vehicle']."','".$order_status."','".$order_reminder."','".$order_date."','".$data['jar_id']."','".$data['customer_id']."','".$order_activestatus."')";
