            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li ng-hide="!isaquaadmin()" ng-controller="Dashboard"><a><i class="fa fa-tint"></i> Aqua Agency <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li ng-hide="!isgasadmin()" ng-controller="Dashboard" ><a><i class="fa fa-fire"></i> Go Gas Agency<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
