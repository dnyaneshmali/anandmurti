...
<form name="addaaquaform" class="form-horizontal form-label-left" nonvalidate>
                    ...
                    <!--   <span class="section">Personal Info</span> -->
                      ...
                      <div class="item form-group">
                        ...
                        <div class=" form-group col-md-6 col-sm-6 col-xs-12" >
                          <input type="text" ng-model="aquacustomers.acustomer_number"  ng-pattern="/^[0-9]{10}$/"  id="acustomer_number" class="form-control" name="acustomer_number" ng-pattern="/^[0-9]{1,10}$/"
       required/>
