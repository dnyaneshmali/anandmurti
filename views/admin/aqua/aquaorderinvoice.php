                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <tr ng-repeat="invoicedata in aquainvoicedata | filter:clisearch" ng-form="subForm">
                          ...
                          <td ng-if="invoicedata.invoice_status==0"><a data-toggle="tooltip" title="Pending"><button class="btn btn-danger"><i class="fa fa-spinner"></i></button></a></td>
                          <td ng-if="invoicedata.invoice_status==1"><a data-toggle="tooltip" title="Complete"><button class="btn btn-success"><i class="fa fa-check-circle"></i></button></a></td>
