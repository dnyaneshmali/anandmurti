                    ...
                    <!--   <p>For alternative validation library <code>parsleyJS</code> check out in the <a href="form.html">form page</a>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="vowner_name">Vehicle Owner Name <span class="required">*</span>
                         ...
                         <div class=" form-group col-md-6 col-sm-6 col-xs-12 input-group" >
                          ...
                          <input type="text" placeholder="Vehicle owner name" ng-model="vdetails.vowner_name" id="vowner_name" class="form-control" name="vowner_name" required />
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class=" form-group col-md-6 col-sm-6 col-xs-12 input-group" >
                          ...
                          <input type="text" placeholder="Vehicle Number" ng-model="vdetails.vehicle_number" id="vehicle_number" class="form-control" name="vehicle_number" required />
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class=" form-group col-md-6 col-sm-6 col-xs-12 input-group">
                          ...
                          <input type="text" placeholder="Vehicle Contact number" ng-model="vdetails.vehicle_contact_number" id="vehicle_contact_number" class="form-control" name="vehicle_contact_number"
       required/>
                        </div>
                      </div>
