...
<form name="addadminform" class="form-horizontal form-label-left" nonvalidate>
                    ...
                    <!--   <p>For alternative validation library <code>parsleyJS</code> check out in the <a href="form.html">form page</a>
                      ...
                      <div class="item form-group">
                        ...
                        <div class=" form-group col-md-6 col-sm-6 col-xs-12" ng-class="{ 'has-error' : addadminform.username.$invalid && !addadminform.username.$pristine }" >
                          ...
                          <p class="val-style" ng-show="addadminform.username.$invalid && !addadminform.username.$pristine" class="help-block"> username is required.</p>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Full Name <span class="required">*</span>
                         ...
                         <div class=" form-group col-md-6 col-sm-6 col-xs-12">
                          ...
                          <p class="val-style" ng-show="addadminform.fullname.$invalid && !addadminform.fullname.$pristine" class="help-block"> fullname is required.</p>
                        </div>
                      </div>
                       ...
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Email <span class="required">*</span>
                         ...
                         <div class=" form-group col-md-6 col-sm-6 col-xs-12">
                          ...
                          <p class="val-style" ng-show="addadminform.email.$invalid && !addadminform.email.$pristine" class="help-block"> email is required with correct format.</p>
                        </div>
                      </div>
       ...
       required/>
                          ...
                          <p class="val-style" ng-show="addadminform.phone.$invalid && !addadminform.phone.$pristine" class="help-block"> 10 digit phone is required.</p>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class=" form-group col-md-6 col-sm-6 col-xs-12">
                          ...
                          <p class="val-style" ng-show="addadminform.password.$invalid && !addadminform.password.$pristine" class="help-block"> password is required.</p>
                        </div>
                        </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-5 col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-4">
                          <button type="submit" ng-click="reset()" ng-disabled="!addadminform.$valid" class="btn btn-primary">Cancel</button>
