                     ...
                     <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="      connection_cylinder_deposit">Refil Payment Details<span class="required">*</span>
                         ...
                         <div class=" form-group col-md-6 col-sm-6 col-xs-12" >
                          ...
                          <p style="color:red;" ng-show="refilform.connection_cylinder_deposit.$invalid && !connectionform.connection_cylinder_deposit.$pristine" class="help-block"> required</p>
                        </div>
                      </div>
                       ...
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="      connection_depreciation"> Refil Amount<span class="required">*</span>
                         ...
                         <div class=" form-group col-md-6 col-sm-6 col-xs-12" >
                          ...
                          <p style="color:red;" ng-show="refilform.connection_depreciation.$invalid && !connectionform.connection_depreciation.$pristine" class="help-block"> required</p>
                        </div>
                      </div>
                           <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="connection_other">Connection Other<span class="required">*</span>
                         ...
                         <div class=" form-group col-md-6 col-sm-6 col-xs-12" >
                          ...
                          <p style="color:red;" ng-show="refilform.connection_other.$invalid && !connectionform.connection_other.$pristine" class="help-block"> required</p>
                        </div>
                      </div>
