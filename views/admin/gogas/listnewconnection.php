...
<tr>
                    ...
                    <button ng-if="checkconninv == 0" type="button" ng-disabled="!taxform.$valid" class="btn btn-default" ng-click="saveconnectioninvoice(gcustomer_id,connection_id,ctax,ftotal);">Save</button>
