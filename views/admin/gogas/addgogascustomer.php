                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <div class=" form-group col-md-6 col-sm-6 col-xs-12" ng-class="{ 'has-error' : addgogasform.gcustomer_pincode.$invalid && !addgogasform.gcustomer_pincode.$pristine }" >
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-home"></i></span>
                          <input type="text" placeholder="Pin-Code" ng-model="gogascustomers.gcustomer_pincode" ng-pattern="/^[0-9]{6}$/" id="  gcustomer_pincode" class="form-control" name="gcustomer_pincode" required />
                        </div>
