                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr ng-repeat="expensive in data | filter:clisearch"  ng-form="subForm">
                          <td ng-if="!isedit(expensive.gogasexpensive_id)">{{expensive.person_name}}</td>
                          <td ng-if="!isedit(expensive.gogasexpensive_id)">{{expensive.exp_desc}}</td>
                          <td ng-if="!isedit(expensive.gogasexpensive_id)">{{expensive.exp_amount}}</td>
                          <td ng-if="!isedit(expensive.gogasexpensive_id)">{{expensive.exp_date}}</td>
                        
                          
                          <td ng-if="!isedit(expensive.gogasexpensive_id)">
                              <a  data-toggle="tooltip" title="Delete"><button class="btn btn-danger" ng-click="deleteexpensive(expensive.gogasexpensive_id,$index);"><i class="fa fa-trash"></i></button></a>
                               <a  data-toggle="tooltip" title="Edit"><button class="btn btn-warning" value="{{btnName}}" ng-click="setedit(expensive.gogasexpensive_id,expensive);"><i class="fa fa-edit"></i></button></a>

                            <!--   <button class="btn btn-danger" ng-click="deleteuser(expensive.gogasexpensive_id,$index);">Delete</button> 
                              <button class="btn btn-warning" value="{{btnName}}" ng-click="setedit(expensive.gogasexpensive_id, expensive);">Edit</button> -->
                        ...
                        <p style="color:red;" ng-show="subForm.exp_amount.$error.required"> Amount is required.</p>
                          ...
                          <td ng-if="isedit(expensive.gogasexpensive_id)"> <a  data-toggle="tooltip" title="Update"><button class="btn btn-success" ng-click="updateexpensive(expensive);"><i class="fa fa-check"></i></button></a>
